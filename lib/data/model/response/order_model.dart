...
class OrderModel {
  ...
  OrderModel(
      {this.id,
        ...
        this.bed3aDeliveryId,
        this.customer,
        this.orderNote,
        this.billingAddress,
        this.sellerInfo,
        this.expectedDate,
        this.bed3aDeliveryCharge,
        this.isPause,
  ...
  OrderModel.fromJson(Map<String, dynamic> json) {
    ...
    bed3aDeliveryId = json['delivery_man_id'];
    ...
    if(json['bed3aDelivery_charge'] != null){
      try{
        bed3aDeliveryCharge = json['bed3aDelivery_charge'].toDouble();
      }catch(e){
        bed3aDeliveryCharge = double.parse(json['bed3aDelivery_charge'].toString());
      }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['delivery_man_id'] = bed3aDeliveryId;
    if (customer != null) {
    ...
    data['bed3aDelivery_charge'] = bed3aDeliveryCharge;
