...
ThemeData light = ThemeData(
  ...
  textTheme: const TextTheme(
    ...
    titleLarge: TextStyle(fontWeight: FontWeight.w800, color: ColorResources.colorBlack, ),
    ...
    tertiaryContainer: Color(0xFFADC9F3),
      ...
      primaryContainer: Color(0xFF9AECC6),secondaryContainer: Color(0xFFF2F2F2),).copyWith(error: const Color(0xFFFC6A57)),
);