...
import 'package:bed3aDelivery/view/base/code_picker_widget.dart';
import 'package:bed3aDelivery/view/base/custom_button.dart';
import 'package:bed3aDelivery/view/base/custom_snackbar.dart';
import 'package:bed3aDelivery/view/base/custom_text_field.dart';
import 'package:bed3aDelivery/view/screens/auth/widget/html_view_Screen.dart';
import 'package:bed3aDelivery/view/screens/dashboard/dashboard_screen.dart';
import 'package:bed3aDelivery/view/screens/forget_password/forget_password_screen.dart';
                          ...
                          child: Row(children: [
                            SizedBox(width: Dimensions.loginColor,
                              child: CodePickerWidget(
                                ...
                                showFlagMain: true,
                                flagWidth: 25,
                                textStyle: rubikRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.displayLarge!.color),
