...
class _OrderTrackingScreenState extends State<OrderTrackingScreen> {
  ...
  Widget build(BuildContext context) {
    Get.find<OrderController>().setSelectedOrderLatLng(LatLng(
        double.parse(widget.orderModel!.shippingAddress!.latitude ?? '0') ?? 0,
        ...
        return ExpandableBottomSheet(
          ...
          persistentHeader: Container(
            ...
            child: Text(
                ...
                style:
                    rubikRegular.copyWith(color: Theme.of(context).cardColor)),
          ),
