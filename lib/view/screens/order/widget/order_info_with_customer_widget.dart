...
import 'package:bed3aDelivery/view/screens/home/widget/receiver_widget.dart';
import 'package:get/get.dart';
import 'package:bed3aDelivery/view/screens/order/widget/order_action_item_widget.dart';
import 'package:bed3aDelivery/view/screens/order/widget/order_current_status_change_dialog.dart';
import 'package:bed3aDelivery/view/screens/order/widget/tracking_stepper_widget.dart';
import 'package:bed3aDelivery/view/screens/order_tracking/order_tracking_screen.dart';

class OrderInfoWithCustomerWidget extends StatelessWidget {
  final OrderModel? orderModel;
  final bool fromMap;
  const OrderInfoWithCustomerWidget(
      {Key? key, this.orderModel, this.fromMap = false})
      : super(key: key);
        ...
        return Container(
          ...
          child: Column(
            children: [
              ...
              Divider(
                  height: .75,
                  color: Theme.of(context).primaryColor.withOpacity(.725)),
              Padding(
                padding: EdgeInsets.symmetric(
                    vertical: Dimensions.paddingSizeDefault),
