      ...
      child: Column(mainAxisSize: MainAxisSize.min,
        children: [
          Padding(
            ...
            child: Text('item_info'.tr, style: rubikMedium.copyWith(color: Theme.of(context).colorScheme.secondary,fontSize: Dimensions.fontSizeLarge),),
          ),
          ListView.builder(
            shrinkWrap: true,
              ...
              return Column(crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Padding(
                      ...
                      child: Text('${'item'.tr} ${index+1}',style: rubikRegular.copyWith(fontSize: Dimensions.fontSizeDefault),),
                    ),
                    Row(children: [
