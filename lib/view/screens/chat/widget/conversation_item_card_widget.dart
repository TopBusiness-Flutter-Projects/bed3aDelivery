...
import 'package:bed3aDelivery/data/model/response/chat_model.dart';
import 'package:bed3aDelivery/utill/app_constants.dart';
import 'package:bed3aDelivery/view/screens/chat/chat_screen.dart';
...
import 'package:bed3aDelivery/view/base/custom_ink_well.dart';
      ...
      builder: (chatController) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            color: chat.seenBybed3aDelivery == 1? Theme.of(context).cardColor : Theme.of(context).primaryColor.withOpacity(.1),
