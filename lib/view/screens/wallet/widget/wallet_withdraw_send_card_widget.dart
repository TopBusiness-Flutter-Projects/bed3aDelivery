...
import 'package:bed3aDelivery/view/screens/withdraw/withdraw_request_screen.dart';
        ...
        builder: (profileController) {
          return Stack(
            children: [
              ...
              Container(width: MediaQuery.of(context).size.width-70,height: 200,
                decoration: BoxDecoration(
              ...
              Container(
                ...
                child: Column(mainAxisAlignment: MainAxisAlignment.center,crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    ...
                    InkWell(
                      onTap: ()=> Get.to(const BalanceWithdrawScreen()),
                      child: Container(height: 40,width: 250,
                        decoration: BoxDecoration(
                            color:Get.isDarkMode? Theme.of(context).hintColor.withOpacity(.5) : Theme.of(context).cardColor,
